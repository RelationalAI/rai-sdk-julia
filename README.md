...
The RelationalAI (RAI) SDK for Julia enables developers to access the RAI
REST APIs from Julai.

* You can find RelationalAI Python SDK documentation at <https://docs.relational.ai/rkgms/sdk/julia-sdk>
