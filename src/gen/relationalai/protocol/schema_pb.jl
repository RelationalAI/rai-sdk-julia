# Autogenerated using ProtoBuf.jl v1.0.5 on 2022-08-31T16:58:13.888
...
export PrimitiveType, RelInt128, Kind, RelUInt128, PrimitiveValue, RelTuple, RelType
export ConstantType, RelationId, ValueType
...
@enumx PrimitiveType UNSPECIFIED_TYPE=0 INT_128=1 INT_64=2 INT_32=3 INT_16=4 INT_8=5 UINT_128=6 UINT_64=7 UINT_32=8 UINT_16=9 UINT_8=10 FLOAT_64=11 FLOAT_32=12 FLOAT_16=13 CHAR=14 BOOL=15 STRING=16 VARIABLE_SIZE_STRING=18
PB.reserved_fields(::Type{PrimitiveType.T}) = (names = String[], numbers = Union{Int,UnitRange{Int}}[17])
...
struct PrimitiveValue{T1<:Union{Nothing,OneOf{<:Union{RelInt128,Int64,Int32,RelUInt128,UInt64,UInt32,Float64,Float32,Bool,Vector{UInt8}}}}}
    tag::PrimitiveType.T
    value::T1
end
